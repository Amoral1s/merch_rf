...
<div id="reviews" class="woocommerce-Reviews wrapper  wrapper-feed">
	...
	<div class="right popup popup-single-review form form-white">
		<div class="close">
		...
		<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
			<div id="review_form_wrapper">
				<div id="review_form" class="form">
					<b class="mini-title">Написать отзыв</b>
					<div class="mini-subtitle">
						Обратная связь помогает развиваться в нужном направлении
					</div>
					<?php
					...
					<small class="form-text">
						Нажимая кнопку "Отправить" я даю согласие на <a href="<?php the_permalink(3); ?>" target="blank">обработку своих персональных данных</a>
					</small>
				</div>
			</div>
		<?php else : ?>
