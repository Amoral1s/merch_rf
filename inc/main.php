	...
	function main_theme_setup() {
		...
		register_nav_menus(
			array(
				...
				'menu-2' => esc_html__( 'Footer О компании', 'main-theme' ),
				'menu-3' => esc_html__( 'Footer Клиентам', 'main-theme' ),
				'menu-4' => esc_html__( 'Footer Продукция', 'main-theme' ),
				'menu-5' => esc_html__( 'Footer Услуги', 'main-theme' ),
